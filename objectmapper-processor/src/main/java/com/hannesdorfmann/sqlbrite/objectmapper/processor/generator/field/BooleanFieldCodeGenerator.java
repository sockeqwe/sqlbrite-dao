 ...
 */
public class BooleanFieldCodeGenerator implements CodeGenerator {

  private ColumnAnnotatedField field;

  public BooleanFieldCodeGenerator(ColumnAnnotatedField field) {
    this.field = field;
  }
  ...
  @Override public void generateAssignStatement(CodeBlock.Builder builder, String objectVarName,
    ...
    builder.addStatement("$L.$L = $L.getInt($L) == 1", objectVarName, field.getFieldName(),
