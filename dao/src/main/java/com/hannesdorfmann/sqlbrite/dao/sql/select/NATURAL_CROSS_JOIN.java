 ...
 */
public class NATURAL_CROSS_JOIN extends SqlCursorCompileableChildNode {

  private final String sql;
  private final Set<String> affectedTables;

  public NATURAL_CROSS_JOIN(SqlNode previous, String tableToJoin) {
    super(previous);
    sql = " NATURAL CROSS JOIN " + tableToJoin;
