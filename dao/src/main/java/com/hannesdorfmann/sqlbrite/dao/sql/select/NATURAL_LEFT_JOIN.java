 ...
 */
public class NATURAL_LEFT_JOIN extends SqlCursorCompileableChildNode {

  private final String sql;
  private final Set<String> affectedTables;

  public NATURAL_LEFT_JOIN(SqlNode previous, String tableToJoin) {
    super(previous);
    sql = " NATURAL LEFT JOIN " + tableToJoin;
